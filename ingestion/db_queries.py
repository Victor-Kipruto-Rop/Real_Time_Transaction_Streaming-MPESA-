...
class DatabaseQueries:
    ...
    def get_transactions_by_phone(phone_number: str, limit: int = 100) -> List[Dict]:
        ...
        """
        return (
            DatabaseQueries.execute_query(query, (phone_number, limit), fetch_one=False)
            or []
        )
    ...
    def get_transaction_statistics(start_date: str, end_date: str) -> Optional[Dict]:
        ...
        return DatabaseQueries.execute_query(
            query, (start_date, end_date), fetch_one=True
        )
...
class QueryPerformanceMonitor:
    ...
    def log_query_time(query_name: str, elapsed_time: float):
        ...
        QueryPerformanceMonitor._metrics.append(
            {"query": query_name, "elapsed_time": elapsed_time}
        )
