...
class DatabaseBenchmark:
    ...
    def __init__(self, host='localhost', port=5432, database='mpesa_analytics',
                 user='data_engineer', password='change_me'):
    ...
    def benchmark_connection_pool(self, pool_size: int = 10, 
    ...
    def benchmark_batch_insert(self, batch_size: int = 100, 
        ...
        return {
            ...
            'throughput_records_per_sec': round(total_records / (sum(batch_times) / 1000), 2)
        }
