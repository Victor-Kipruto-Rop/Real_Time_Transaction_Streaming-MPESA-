        ...
        callback_data = {
            'Body': {
                'stkCallback': {
                    ...
                    'ResultDesc': 'Success' if random.random() > 0.1 else 'User cancelled',
                    'CallbackMetadata': {
                        'Item': [
                            {'Name': 'Amount', 'Value': random.randint(100, 5000)},
                            {'Name': 'MpesaReceiptNumber', 'Value': f'RCP{random.randint(10000, 99999)}'},
                            {'Name': 'PhoneNumber', 'Value': f'2547{random.randint(10000000, 99999999)}'}
                        ]
                    }
                }
            }
